 ...
 * @Author collapsar
 */
public class MysqlCreateOrReplaceViewHandler implements ResponseHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(MysqlCreateOrReplaceViewHandler.class);
    private NonBlockingSession session;
    private RouteResultset rrs;
    private volatile byte packetId;
    private ViewMeta vm;

    public MysqlCreateOrReplaceViewHandler(NonBlockingSession session, RouteResultset rrs, ViewMeta vm) {
