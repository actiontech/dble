...
package com.actiontech.dble.config.loader.zkprocess.entity.sharding.schema;
...
public class TableGsonAdapter implements JsonSerializer<Table>, JsonDeserializer<Table> {
    ...
    public Table deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
        ...
        try {
            return context.deserialize(element, Class.forName("com.actiontech.dble.config.loader.zkprocess.entity.sharding.schema." + type));
