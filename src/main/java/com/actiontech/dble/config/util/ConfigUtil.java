...
public final class ConfigUtil {
    ...
    public static String getAndSyncKeyVariables(List<ReloadConfig.ChangeItem> changeItemList, boolean needSync) throws Exception {
        ...
        try {
            String msg = null;
            List<ReloadConfig.ChangeItem> needCheckItemList = changeItemList.stream().filter(changeItem -> (changeItem.getItem() instanceof PhysicalDbInstance || changeItem.getItem() instanceof PhysicalDbGroup) && changeItem.getType() == 1).collect(Collectors.toList());
