...
public final class ManagerSelectHandler {
    ...
    public void execute(ManagerConnection c, String stmt) {
        ...
        if (sqlSelectQuery instanceof MySqlSelectQueryBlock) {
            ...
            if (mysqlFrom == null) {
                noTableSelect(c, stmt, selectQueryBlock.getSelectList());
            } else {
                c.setSchema(ManagerSchemaInfo.SCHEMA_NAME);
                c.getSession2().execute(c.getSchema(), selectStatement);
            }
    ...
    private void noTableSelect(ManagerConnection c, String stmt, List<SQLSelectItem> items) {
