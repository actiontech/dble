...
public final class ShowSysParam {
    ...
    private static final String[] PARAM_DESCRIPTION = {
            ...
            "The size of frontend NIOProcessor, the default value is the number of processors available to the Java virtual machine",
            "The size of backend NIOProcessor, the default value is the number of processors available to the Java virtual machine",
            "The size of fixed thread pool named of frontend businessExecutor,the default value is the number of processors available to the Java virtual machine * 2",
            "The size of fixed thread pool named of backend businessExecutor,the default value is the number of processors available to the Java virtual machine * 2",
            ...
            "The executor for complex query.The default value is min(8, default value of processorExecutor)",
