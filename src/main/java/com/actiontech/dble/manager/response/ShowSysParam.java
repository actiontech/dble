...
public final class ShowSysParam {
    ...
    private static final String[] PARAM_DESCRIPTION = {
            ...
            "The xa log ready period.The default value is 1000ms",
            ...
            "The slow SQL statistics limit,if the slow SQL record is large than the size,the record will be ready.The default value is 10",
            ...
            "The period for ready the large resultSet SQL statistics.The default value is 6000000ms",
