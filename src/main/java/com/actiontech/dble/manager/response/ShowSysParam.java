...
public final class ShowSysParam {
    ...
    public static void execute(ManagerConnection c) {
        ...
        paramValues.add(new ParamInfo("shardingNodeHeartbeatPeriod", sysConfig.getShardingNodeHeartbeatPeriod() / 1000 + " Seconds", "The period between the heartbeat jobs for checking the health of all write/read data sources. The default is 10 seconds"));
