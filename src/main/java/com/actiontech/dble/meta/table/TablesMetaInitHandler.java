...
public class TablesMetaInitHandler {
    ...
    public TablesMetaInitHandler(AbstractSchemaMetaHandler schemaMetaHandler, String schema, Map<String, Set<String>> dataNodeMap, Set<String> selfNode, boolean isReload) {
