...
public final class GlobalTableUtil {
    ...
    public static boolean isInnerColExist(SchemaUtil.SchemaInfo schemaInfo, StructureMeta.TableMeta orgTbMeta) {
        ...
        String warnStr = AlarmCode.USHARD_CORE_TABLE_CHECK_WARN + schemaInfo.getSchema() + "." + schemaInfo.getTable() +
                    ...
                    if (row.containsKey(GlobalTableUtil.INNER_COLUMN)) {
                        ...
                        try {
                            ...
                            if (columnsList == null ||
                                ...
                                LOGGER.warn(AlarmCode.USHARD_CORE_TABLE_CHECK_WARN + map.getDataNode() + "." + map.getTableName() +
