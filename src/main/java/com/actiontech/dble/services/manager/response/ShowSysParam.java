...
public final class ShowSysParam {
    ...
    public static void execute(ManagerService service) {
        ...
        paramValues.add(new ParamInfo("capClientFoundRows", sysConfig.isCapClientFoundRows() + "", "Whether to turn on EOF_Packet to return found rows,The default value is false"));
        ...
        paramValues.add(new ParamInfo("idleTimeout", sysConfig.getIdleTimeout() / 1000 / 60 + " Minutes", "The max allowed idle time of front connection. The connection will be closed if it is timed out after last read/write/heartbeat..The default value is 10min"));
        ...
        paramValues.add(new ParamInfo("traceEndPoint", sysConfig.getTraceEndPoint() + "", "The trace Jaeger server endPoint"));
