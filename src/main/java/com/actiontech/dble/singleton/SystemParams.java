...
public final class SystemParams {
    ...
    private SystemParams() {
        ...
        readOnlyParams.add(new ParamInfo("writeToBackendWorker", sysConfig.getWriteToBackendWorker() + "", "The executor for complex query.The default value is min(8, default value of processorExecutor)"));
