...
public final class SystemParams {
    ...
    private SystemParams() {
        ...
        readOnlyParams.add(new ParamInfo("managerFrontWorker", sysConfig.getManagerFrontWorker() + "", "The size of fixed thread pool named of managerFrontWorker, the default value is 2"));
