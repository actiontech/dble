...
import com.oceanbase.obsharding_d.backend.mysql.nio.handler.util.HeapItem;
...
import com.oceanbase.obsharding_d.services.factorys.FinalHandlerFactory;
...
public class MultiNodeSelectHandler extends MultiNodeQueryHandler {
    ...
    private void startOwnThread() {
        OBsharding_DServer.getInstance().getComplexQueryExecutor().execute(() -> ownThreadJob());
    }
