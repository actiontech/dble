...
public class XAAnalysisHandler extends XAHandler {
    ...
    public static final Pattern XAID_STMT = Pattern.compile(OBsharding_DServer.NAME + "Server." + SystemConfig.getInstance().getInstanceName() + "[.](\\d+)(.[^\\s]+)?", Pattern.CASE_INSENSITIVE);
    ...
    private void checkResidualXid(boolean isStartup) {
        ...
        usedXaid.add(OBsharding_DServer.getInstance().getXaIDInc());
        if (LOGGER.isDebugEnabled()) {
