...
import com.oceanbase.obsharding_d.alarm.UcoreGrpc;
import com.oceanbase.obsharding_d.alarm.UcoreInterface;
...
import com.oceanbase.obsharding_d.util.PropertiesUtil;
...
public final class UcoreSender extends AbstractConsulSender {
    ...
    private static final String SOURCE_COMPONENT_TYPE = "OBsharding-D";
    ...
    private void setStubIfPossible(UcoreGrpc.UcoreBlockingStub stubTemp) {
        if (connectionDetached) {
            LOGGER.info("the OBsharding-D had detach cluster");
            return;
        }
        this.stub = stubTemp;
    }
