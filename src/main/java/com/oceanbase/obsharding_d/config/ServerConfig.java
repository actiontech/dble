...
import com.oceanbase.obsharding_d.backend.datasource.PhysicalDbGroupDiff;
...
public class ServerConfig {
    ...
    public void getAndSyncKeyVariables() throws Exception {
        ConfigUtil.checkOBsharding_DAndMysqlVersion(confInitNew.getDbGroups());
        ConfigUtil.getAndSyncKeyVariables(confInitNew.getDbGroups(), true);
        OBsharding_DServer.getInstance().getConfig().setLowerCase(OBsharding_DTempConfig.getInstance().isLowerCase());
    }
    ...
    private boolean apply(Map<UserName, UserConfig> newUsers,
        ...
        try {
            ...
            OBsharding_DServer.getInstance().reloadSystemVariables(newSystemVariables);
            ...
            this.lowerCase = OBsharding_DTempConfig.getInstance().isLowerCase();
