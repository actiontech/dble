...
import static com.oceanbase.obsharding_d.config.model.db.PoolConfig.DEFAULT_IDLE_TIMEOUT;
...
public final class SystemConfig {
    ...
    //tcp
    private int tcpKeepIdle = OBsharding_DSocketOptions.getInstance().getTcpKeepIdle();
    private int tcpKeepInterval = OBsharding_DSocketOptions.getInstance().getTcpKeepInterval();
    private int tcpKeepCount = OBsharding_DSocketOptions.getInstance().getTcpKeepCount();
