 ...
 */
public class OBsharding_DCreateTableParser extends MySqlCreateTableParser {

    private static final Logger LOGGER = LoggerFactory.getLogger(OBsharding_DCreateTableParser.class);

    public OBsharding_DCreateTableParser(String sql) {
        super(sql);
    }
