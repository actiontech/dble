...
import com.oceanbase.obsharding_d.backend.mysql.proto.handler.ProtoHandlerResultCode;
...
import com.oceanbase.obsharding_d.util.CompressUtil;
...
public abstract class AbstractConnection implements Connection {
    ...
    public void setSocketParams(boolean isFrontChannel) throws IOException {
        ...
        OBsharding_DSocketOptions.getInstance().setKeepAliveOptions(channel);
    ...
    /**
     * heartbeat of SLB/LVS only create an tcp connection and then close it immediately without any data write to OBsharding-D .(send reset)
     *
     * @return
     */
