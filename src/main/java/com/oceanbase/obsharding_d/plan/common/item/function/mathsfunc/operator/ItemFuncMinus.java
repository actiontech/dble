...
package com.oceanbase.obsharding_d.plan.common.item.function.mathsfunc.operator;

import com.oceanbase.obsharding_d.plan.common.field.Field;
import com.oceanbase.obsharding_d.plan.common.item.Item;
import com.oceanbase.obsharding_d.plan.common.item.function.primary.ItemFuncAdditiveOp;
...
public class ItemFuncMinus extends ItemFuncAdditiveOp {
    ...
    public ItemFuncMinus(Item a, Item b, int charsetIndex) {
    ...
    protected Item cloneStruct(boolean forCalculate, List<Item> calArgs, boolean isPushDown, List<Field> fields) {
        ...
        if (!forCalculate)
            ...
            newArgs = calArgs;
        return new ItemFuncMinus(newArgs.get(0), newArgs.get(1), charsetIndex);
    }
