...
import com.oceanbase.obsharding_d.server.handler.MysqlSystemSchemaHandler;
...
public class DruidSelectParser extends DefaultDruidParser {
    ...
    public void changeSql(SchemaConfig schema, RouteResultset rrs, SQLStatement stmt)
        ...
        SQLSelectStatement selectStmt = (SQLSelectStatement) stmt;
        SQLSelectQuery sqlSelectQuery = selectStmt.getSelect().getQuery();
        SchemaConfig sqlSchema = OBsharding_DServer.getInstance().getConfig().getSchemas().get(rrs.getSchema());
