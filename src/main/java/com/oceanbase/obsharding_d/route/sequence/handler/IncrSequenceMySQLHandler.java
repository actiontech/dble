...
import static com.oceanbase.obsharding_d.config.ConfigFileName.SEQUENCE_DB_FILE_NAME;
    ...
    private long execSeqFetcher(SequenceVal seqVal) throws SQLNonTransientException {
        try {
            ...
            if (values == null) {
                ...
                String msg = "sequence," + seqVal.seqName + " has not been set, please check configure in OBsharding-D_sequence";
                LOGGER.info(msg);
