...
import com.oceanbase.obsharding_d.route.LoadDataRouteResultsetNode;
...
import com.oceanbase.obsharding_d.util.ObjectUtil;
...
public final class ServerLoadDataInfileHandler implements LoadDataInfileHandler {
    ...
    private void parseLoadDataPram() {
        ...
        String charset = statement.getCharset() != null ? statement.getCharset() : OBsharding_DServer.getInstance().getSystemVariables().getDefaultValue("character_set_database");
