...
import com.oceanbase.obsharding_d.singleton.ConnectionSerializableLock;
...
import com.oceanbase.obsharding_d.util.DelayService;
...
public abstract class FrontendService<T extends UserConfig> extends AbstractService {
    ...
    public void handle(ServiceTask task) {
        ...
        OBsharding_DServer.getInstance().getFrontHandlerQueue().offer(task);
    }
        ...
        try {
            ...
            do {
                ...
                try {
                    ...
                    try {
                        OBsharding_DThreadPoolProvider.beginProcessFrontBusinessTask();
    ...
    public void notifyTaskThread() {
        OBsharding_DServer.getInstance().getFrontHandlerQueue().offerFirst(new NotificationServiceTask(this));
    }
