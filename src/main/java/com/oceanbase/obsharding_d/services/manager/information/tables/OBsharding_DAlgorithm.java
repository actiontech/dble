...
public class OBsharding_DAlgorithm extends ManagerBaseTable {

    private static final String TABLE_NAME = "obsharding-d_algorithm";
    ...
    protected List<LinkedHashMap<String, String>> getRows() {
        ...
        Map<String, AbstractPartitionAlgorithm> functionMap = OBsharding_DServer.getInstance().getConfig().getFunctions();
