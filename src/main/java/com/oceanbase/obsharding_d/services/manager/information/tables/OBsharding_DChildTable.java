...
public class OBsharding_DChildTable extends ManagerBaseTable {

    private static final String TABLE_NAME = "obsharding-d_child_table";
    ...
    protected List<LinkedHashMap<String, String>> getRows() {
        return OBsharding_DTable.getTableByType(OBsharding_DTable.TableType.CHILD);
    }
