...
public class OBsharding_DEntryTablePrivilege extends ManagerBaseTable {
    protected static final Logger LOGGER = LoggerFactory.getLogger(OBsharding_DEntryTablePrivilege.class);

    private static final String TABLE_NAME = "obsharding-d_entry_table_privilege";
    ...
    public OBsharding_DEntryTablePrivilege() {
        super(TABLE_NAME, 9);
    }
