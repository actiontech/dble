...
public class OBsharding_DReloadStatus extends ManagerBaseTable {
    private static final String TABLE_NAME = "obsharding-d_reload_status";
    ...
    public OBsharding_DReloadStatus() {
        super(TABLE_NAME, 8);
    }
