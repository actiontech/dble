...
public class OBsharding_DThreadUsage extends ManagerBaseTable {

    private static final String TABLE_NAME = "obsharding_d_thread_usage";
    ...
    public OBsharding_DThreadUsage() {
        super(TABLE_NAME, 4);
    }
