        ...
        try {
            if (ma.group(2) != null) {
                ...
                if (ma.group(4) != null) {
                    ...
                    if (OBsharding_DServer.getInstance().getConfig().getSchemas().get(schema) == null) {
                    ...
                    if (ma.group(9) != null) {
                        ...
                        if (OBsharding_DServer.getInstance().getConfig().getSchemas().get(schema).getTables().get(table) == null &&
