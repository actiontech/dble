...
public final class ShowHelp {
    ...
    static {
        ...
        //select
        HELPS.put("select @@VERSION_COMMENT", "Show the version comment of OBsharding-D");
        // show
        ...
        HELPS.put("show @@reload_status", "Report latest reload status in this OBsharding-D");
        HELPS.put("show @@user", "Report all user in this OBsharding-D");
        HELPS.put("show @@user.privilege", "Report privilege of all business user in this OBsharding-D");
        ...
        //check @@metadata
        HELPS.put("check @@metadata", "show last time of `reload @@metadata`/start OBsharding-D");
        ...
        HELPS.put("reload @@statistic_table_size = ? [where table='?' | where table in (OBsharding-D_information.tableA,...)]", "Statistic table size");
