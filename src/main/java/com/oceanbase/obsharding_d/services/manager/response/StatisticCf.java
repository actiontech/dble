...
import com.oceanbase.obsharding_d.memory.unsafe.utils.JavaUtils;
...
import com.oceanbase.obsharding_d.statistic.sql.UsageData;
import com.oceanbase.obsharding_d.statistic.sql.UsageDataBlock;
            ...
            try {
                ...
                try {
                    if (matcher1.matches()) {
                        ...
                        service.writeErrMessage(ErrorCode.ER_YES, "Usage: reload @@statistic_table_size = 1024 [where table='?' | where table in (OBsharding-D_information.tableA,...)]");
                        return;
                    }
