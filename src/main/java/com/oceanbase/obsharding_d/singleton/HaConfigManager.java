...
import com.oceanbase.obsharding_d.cluster.values.DbInstanceStatus;
...
import com.oceanbase.obsharding_d.config.util.DbXmlWriteJob;
...
import static com.oceanbase.obsharding_d.backend.datasource.PhysicalDbGroup.JSON_LIST;
import static com.oceanbase.obsharding_d.backend.datasource.PhysicalDbGroup.JSON_NAME;
    ...
    public void updateDbGroupConf(PhysicalDbGroup dbGroup, boolean syncWriteConf) {
        ...
        if (isWriting.compareAndSet(false, true)) {
            ...
            try {
                ...
                waitingSet = new HashSet<>();
                OBsharding_DServer.getInstance().getComplexQueryExecutor().execute(dbXmlWriteJob);
            } finally {
