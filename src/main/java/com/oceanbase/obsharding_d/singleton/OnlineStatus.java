...
import com.oceanbase.obsharding_d.cluster.general.bean.InstanceOnline;
...
public final class OnlineStatus {
    ...
    /**
     * when the OBsharding-D start with a cluster online failure,try to init again in the node listener
     *
     * @throws IOException
     */
