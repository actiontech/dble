...
public class AutoTxHandler implements ResponseHandler{
...
//	}
	...
	private static Logger logger = Logger.getLogger(AutoTxHandler.class);
	...
	public AutoTxHandler(RouteResultsetNode[] nodes,Set<BackendConnection> errConnection, NonBlockingSession session, TxOperation txOperation , String closeReason){
		this.nodes = nodes;
