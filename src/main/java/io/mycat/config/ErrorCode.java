...
public interface ErrorCode {
    ...
    int ER_HANDLE_DATA = 4002;
    int ER_OPTIMIZER = 4004;
    int ER_QUERYHANDLER = 4005;
    int ER_NO_VALID_CONNECTION = 5004;
    int ER_FILE_INIT = 5301;
    int ER_FILE_FORCE = 5302;
    int ER_FILE_SYNC = 5303;
    int ER_FILE_READ = 5304;
    int ER_FILE_WRITE = 5305;
    int ER_FILE_RENAME = 5306;
    int ER_FILE_DELETE = 5307;
    int ER_IO_EXCEPTION = 5308;
    int ER_FILE_CREATE = 5313;
    // mysql error code
    int ER_HASHCHK = 1000;
