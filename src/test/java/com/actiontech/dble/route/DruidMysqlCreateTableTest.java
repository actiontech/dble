...
public class DruidMysqlCreateTableTest {
    ...
    protected ShardingService shardingService = new ShardingService(null);
    ...
    public DruidMysqlCreateTableTest() {
        ...
        shardingService.setUser(new UserName("test",null));
    }
    ...
    public void testCreate() throws SQLException {
        ...
        RouteResultset rrs = routeStrategy.route(schema, -1, originSql1, shardingService);
    ...
    public void testInsert() throws SQLException {
        SchemaConfig schema = schemaMap.get("mysqldb");
        RouteResultset rrs = routeStrategy.route(schema, -1, "insert into autoslot (id,sid) values(1,2) ", shardingService);
