...
public class ServerParseTest {
    ...
    public void testDivide() {
        ...
        sql = "/*!OBsharding-D:sql=select 1 from account */create procedure proc_test(userid1 int)\n" +
                "begin\n" +
        ...
        sql1 = "/*!OBsharding-D:sql=select 1 from account */create procedure proc_test(userid1 int)\n" +
                "select * from char_columns;";
        sql2 = "select * from char_columns;";
        Assert.assertEquals(sql1.length() - 1, ParseUtil.findNextBreak(sql1 + sql2));

        sql1 = "/*!OBsharding-D:sql=select 1 from account */create procedure proc_arc(userid1 int)\n" +
                "begin\n" +
                "  insert into xx select * from xxx where userid=userid1;\n" +
                "  update xx set yy=true,zz_time=now() where userid=userid1;\n" +
                "end;";
        ...
        sql = "INSERT INTO TEST_TABLE SET VALUE = \"/*!OBsharding-D:sql=select 1 from account */create procedure proc_arc(userid1 int)\n" +
                "begin\n" +
                "  select 'GET the PART 1 END;'\n" +
                "  update xx set yy=true,zz_time=now() where userid=userid1;\n" +
                "end;\" ,ID = 11111";
